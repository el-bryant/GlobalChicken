...
//        mMap.addMarker(new MarkerOptions().position(sydney).title("Marcador en Sydney").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET)));
//        float zoomlevel = 16;
